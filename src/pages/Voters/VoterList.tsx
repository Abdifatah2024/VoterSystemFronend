...
//       cancelEdit();
//     } catch (err) {
//       toast.error((err as any)?.message || t.error);
//     }
//   };
...
//   const uniqueCities = Array.from(new Set(voters.map((v) => v.city))).sort();
//   const uniqueDistricts = Array.from(new Set(voters.map((v) => v.district))).sort();
...
//                     <td className="py-2 px-4">{v.phoneNumber}</td>
