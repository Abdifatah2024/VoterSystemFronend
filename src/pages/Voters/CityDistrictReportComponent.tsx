...
// const translations = {
//   en: {
//     reportTitle: "City-District Voter Report",
//     city: "City",
//     district: "District",
...
//   },
//   so: {
//     reportTitle: "Warbixinta tirakoobka Magaalooyinka iyo Degmooyinka",
//     city: "Magaalo",
//     district: "Degmo",
//     totalVoters: "Wadarta la diwaangaliyey",
//     withVoterId: "Leh Aqoonsi Codbixiye",
//     withoutVoterId: "Aan haysan Kaadhka Cod-bixinta",
//     wantsChange: "Codsaday Bedel",
...
//   // Sort descending by total voters
//   const sortedReport = [...cityDistrictReport].sort(
...
//       acc.wantsToChangeRegistration += item.wantsToChangeRegistration ?? 0;
//       return acc;
//     },
//     {
//       totalVoters: 0,
...
//         item.withVoterId,
//         item.withoutVoterId,
//         item.wantsToChangeRegistration ?? 0,
//       ]),
//       [
//         t.grandTotal,
//         "",
...
//     XLSX.writeFile(wb, "city-district-report.xlsx");
//   };
...
//           (item.wantsToChangeRegistration ?? 0).toLocaleString(),
//         ]),
//         [
//           t.grandTotal,
//           "",
...
//     doc.save("city-district-report.pdf");
//   };
...
//                 <tr>
//                   <th className="py-4 px-6">{t.city}</th>
...
//                   <tr key={idx}>
//                     <td className="py-3 px-6">{item.city ?? "Unknown"}</td>
//                     <td className="py-3 px-6">{item.district ?? "Unknown"}</td>
...
//                     <td className="py-3 px-6 text-right">{(item.wantsToChangeRegistration ?? 0).toLocaleString()}</td>
//                   </tr>
//                 ))}
//               </tbody>
//               <tfoot className="bg-emerald-50 font-semibold">
//                 <tr>
//                   <td className="py-4 px-6" colSpan={2}>{t.grandTotal}</td>
